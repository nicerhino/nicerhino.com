...
//------------------------------------------------------------------------
    ...
    function setBackgroundColorSplitSection() {
        $(".section-title-holder").each(function () {
            $(this).css("background-color", $(this).data("background"));
        });
    }
    
    function verticalSkills() {
        $(".v-skill").each(function (i) {
            skillsColor = $(this).find('span').data("color");
            skillsFill = $(this).find('span').html();
            $(this).find('.v-skill-fill').css("background-color", skillsColor).width(skillsFill).height(skillsFill);
            $(this).find('.v-skill-text').css("bottom", skillsFill);
            $(this).find('span').css("color", skillsColor);
        });
    }
